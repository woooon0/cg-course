...
def main():
    ...
    g_P = glm.ortho(-ortho_width*.5,ortho_width*.5, -ortho_height*.5,ortho_height*.5, -20,20)
    ...
    while not glfwWindowShouldClose(window):
        ...
        # draw world frame
        draw_frame(vao_frame, g_P*P*V*glm.mat4(), MVP_loc)
        ...
        draw_cube_array(vao_cube, g_P*P*V*M, MVP_loc)
